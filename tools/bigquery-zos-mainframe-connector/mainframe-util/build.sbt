...
libraryDependencies ++= Seq(
  ...
  "com.google.apis" % "google-api-services-pubsub" % "v1-rev20230529-2.0.0",
  "com.google.apis" % "google-api-services-dataflow" % "v1b3-rev20230529-2.0.0",
  ("com.google.apis" % "google-api-services-logging" % "v2-rev20230531-2.0.0").excludeAll(exGapiClient),
  "org.apache.avro" % "avro" % "1.7.7",

  //TCP TransportChannelProvider for BigQuery Storage API
  ("io.grpc" % "grpc-okhttp" % "1.56.0").excludeAll(exGuava, exGrpcCore),

  //Grecv server
  ("io.grpc" % "grpc-netty" % "1.56.0").excludeAll(exGuava, exGrpcCore),

  //logging
  "org.apache.logging.log4j" % "log4j-api" % "2.20.0",
  "org.apache.logging.log4j" % "log4j-core" % "2.20.0",
  "org.apache.logging.log4j" % "log4j-slf4j-impl" % "2.20.0", // used by netty and hadoop libs
  "org.apache.logging.log4j" % "log4j-jul" % "2.20.0", // used by grpc-okhttp lib
